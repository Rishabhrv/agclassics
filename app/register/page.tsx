                    ...
                    {resendTimer > 0 ? (
                      ...
                      <button type="button"
                        style={{
                          ...
                          fontFamily: "'Jost', sans-serif", fontSize: 11,
                          color: "#8a6f2e", cursor: "pointer", padding: 0,
                  ...
                  <div style={{ textAlign: "center", marginTop: 10 }}>
                    <button type="button"
                      style={{
                        background: "none", border: "none",
                        fontFamily: "'Jost', sans-serif", fontSize: 11,
                        color: "#6b6b70", cursor: "pointer", padding: 0,
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    {password.length > 0 && (
                      <div style={{ marginTop: 8, display: "flex", gap: 4 }}>
                        {[1, 2, 3, 4].map(lvl => {
                          const str = password.length >= 12 && /[A-Z]/.test(password) && /[0-9]/.test(password) && /[^a-zA-Z0-9]/.test(password) ? 4
